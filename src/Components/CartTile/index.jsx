...
function CartTile({ singleCartItem }) {
    ...
    const { handleRemoveFromCart, handleAddToCart, CartLoading } = useContext(ShoppingCartContext);
        ...
        <Fragment>
            <div className="grid grid-cols-3 items-start gap-5">
                ...
                <div className="ml-auto ">
                    ...
                    <div className="mt-3">
                        <button onClick={() => handleRemoveFromCart(singleCartItem, false)} className="disabled:opacity-100 border border-[#000] mr-1 "
